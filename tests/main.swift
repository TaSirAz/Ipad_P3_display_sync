...
check(OutputColorTag.allCases == [.displayP3, .rec709], "Color A/B exposes only P3 and Rec.709 tags")
check(DisplayConfig.defaultOutputColorTag == .displayP3, "Color A/B starts with the existing P3 baseline")
