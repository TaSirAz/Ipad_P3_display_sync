...
check(OutputColorTag.allCases == [.displayP3, .rec709, .legacyP3], "Color check exposes managed P3/709 and the legacy compositor baseline")
check(DisplayConfig.defaultOutputColorTag == .displayP3, "Color check defaults to the explicit P3 compositor path")
